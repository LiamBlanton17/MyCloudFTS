...
class StreakGambler implements Gambler {
    ...
    constructor(name: string, money: number, initial: number, minimum: number, winMultiplier: number, lossMultiplier: number, target: number, current: number, win: boolean ) {
        this.name = name;
        this.money = money;
        this.initial = initial;
